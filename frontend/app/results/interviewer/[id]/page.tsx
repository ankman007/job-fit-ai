...
function InterviewerResultsPage() {
  ...
  const { id } = useParams();
  const cheatsheets = useSelector((state: RootState) => state.cheatsheets);
  console.log("Found cheatsheet cheatsheets:", cheatsheets);
  ...
  //       appliedPosition: (sheet.content as any).candidate_overview
  //         .current_job_title,
  //       email: (sheet.content as any).candidate_overview.email,
  //       name: (sheet.content as any).candidate_overview.full_name,
  //       location: (sheet.content as any).candidate_overview.location,
  //       phone: (sheet.content as any).candidate_overview.phone_number,
  //       topSkills: (sheet.content as any).candidate_overview.top_score,
  //       website: (sheet.content as any).candidate_overview.website,
  //       linkedin: (sheet.content as any).candidate_overview.linkedin,
  //       github: (sheet.content as any).candidate_overview.github,
  //       rating: "",
  //     }
  //   : null;

  // console.log("Found cheatsheet:", sheet);
            ...
            <div>
              {/* <div className="flex items-center">
                <h1 className="text-3xl font-bold">
                  {formattedCheatsheet?.name}
                </h1>
                {formattedCheatsheet?.rating >= 4 && (
              ...
              <p className="mt-1 text-teal-100">
                {formattedCheatsheet?.appliedPosition}
              </p>
            </div> */}
          ...
          <div className="lg:col-span-2">
            <div className="space-y-8">
              ...
              <InterviewRecommendation
                data={candidateData.interviewRecommendation}
              />
            </div>
          </div>
        </div>
