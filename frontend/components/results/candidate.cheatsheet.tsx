    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <SkillAssessment data={sheet?.skillAssessment} />
          <ConceptRefresh data={sheet?.conceptRefresh} />
          <InterviewQuestions data={sheet?.interviewQuestions} />
