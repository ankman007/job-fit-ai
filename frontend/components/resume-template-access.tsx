    ...
    <>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle className="text-lg">Access Resume Templates</DialogTitle>
          ...
          <div className="py-4 space-y-4">
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              ...
              <ol className="list-decimal pl-5 space-y-1 text-sm text-gray-700">
                ...
                <li>Go to <strong>File → Make a copy</strong> to create your own editable version.</li>
          ...
          <DialogFooter className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2">
            ...
            <Button onClick={handleOpenTemplates} className="bg-teal-600 hover:bg-teal-700 text-white">
              Open Templates
